#!/bin/sh
# cc-guides 0.1.12 src=.claude/fragments/scripts/install-binary.sh fragments=cc-skills@9d162c48d466 | GENERATED — do not edit: edit .claude/fragments/scripts/install-binary.sh/ and run 'cc-guides render'. Everything below is in force.
